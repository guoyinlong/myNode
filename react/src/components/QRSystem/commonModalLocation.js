...
class CommonModal extends React.Component {
  ...
  render(){
    ...
    return(
      <Modal visible={this.props.visible} width='730px' height = '600px'  title={(this.props.flag === 'add')?'添加':'编辑'}
        onCancel={this.handleCancel}
        footer = {[
          <Button onClick={this.handleCancel}>取消</Button>,
          <Button type="primary" onClick={this.handleSubmit(this.props.data.asset_id)}>确定</Button>,
        ]}>
            ...
            <Row  gutter={28}>
              ...
              <Col span={12}>
                <FormItem {...formItemLayout} label = '级别分类'>
                    {getFieldDecorator('type_id',{initialValue:[this.props.data.type_id2]})(<Cascader  placeholder='请选择' style = {{...itemStyle}} options={this.state.myLocationOption} onChange={this.onChange} />)}
                </FormItem>
              </Col>
            </Row>
            ...
            <Row  gutter={28}>
              <Col span={12}>
                ...
                {getFieldDecorator('charger_dept_name',{initialValue:this.props.data.charger_dept_name})(
                  <DeptList resetFlag = {this.state.resetFlag} list={this.state.userList} style={{...itemStyle}} initialData = {this.props.data.charger_dept_name}/>
                )}
                </FormItem>
              </Col>
              <Col span={12}>
            ...
            <Row  gutter={28}>
              <Col span={12}>
                ...
                {getFieldDecorator('charger_name',{initialValue:this.props.data.charger_name})(
                  <StaffList list={this.state.userList} style={{...itemStyle}} initialData = {this.props.data.charger_name}/>
                )}
                </FormItem>
              </Col>
              <Col span={12}>
                ...
                {getFieldDecorator('assetuser_name',{initialValue:this.props.data.charger_name})(
                  <UsersList list={this.state.userList} style={{...itemStyle}} initialData = {this.props.data.assetuser_name}/>
                )}
                </FormItem>
              </Col>
            </Row>
