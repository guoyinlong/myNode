...
class attend_proj_approval extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
  ...
  handleOk = () => {
    ...
    return new Promise((resolve) => {
      dispatch({
        type: 'attend_approval_model/attendProjApprovalSubmit',
        approval_if,
        apply_id,
        approval_advice,
        orig_proc_inst_id,
  ...
  submitcheck = () => {
    ...
    if (approval_if == '不同意') {
      ...
      if (this.state.if_end_task == '1') {
        ...
        return new Promise((resolve) => {
          dispatch({
            type: 'attend_approval_model/attendProjApprovalEnd',
            approval_if,
            apply_id,
            approval_advice,
            orig_proc_inst_id,
  ...
  render() {
    ...
    if (approvalNowList.length > 0) {
      ...
      if (approvalNowList[i].task_type_id == '2') { 
...
attend_proj_approval = Form.create()(attend_proj_approval);
export default connect(mapStateToProps)(attend_proj_approval)
