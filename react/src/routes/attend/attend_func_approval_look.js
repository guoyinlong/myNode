...
class attend_func_approval_look extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
  ...
  render() {
    ...
    const { approvalHiList, applyPersonInfo } = this.props;
...
attend_func_approval_look = Form.create()(attend_func_approval_look);
export default connect(mapStateToProps)(attend_func_approval_look)
