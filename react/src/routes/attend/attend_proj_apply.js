...
import { Button, Form, Row, Icon, Input, Card, Select, Table, DatePicker, message, Modal } from 'antd';
...
class attend_proj_apply extends Component {
  constructor(props) {
  ...
  handleOk = () => {
    ...
    let worktime_team_apply_id = this.state.worktime_team_apply_id;
    basicInfoData["arg_worktime_team_apply_id"] = worktime_team_apply_id;
    ...
    basicInfoData["arg_proj_id"] = projectId;
    basicInfoData["arg_proj_name"] = this.props.form.getFieldValue("proj_id");
    ...
    let approvalData = {};
    approvalData["arg_worktime_team_apply_id"] = worktime_team_apply_id;
    /*下一环节处理人为经办人，直接填写经办人*/
    ...
    approvalDataNext["arg_worktime_team_apply_id"] = worktime_team_apply_id;
    ...
    return new Promise((resolve) => {
      dispatch({
        type: 'attend_apply_model/attendProjApplySubmit',
        basicInfoData,
        approvalData,
        approvalDataNext,
        worktime_team_apply_id,
  ...
  render() {
    console.log('+++++++++++++++++')
    console.log(this.state.absenceDataSource)
    console.log(this.state.absenceDataSourceTemp)
    console.log('+++++++++++++++++')
    ...
    // this.setState({ absenceDataSource: saveInfo });
...
attend_proj_apply = Form.create()(attend_proj_apply);
export default connect(mapStateToProps)(attend_proj_apply);
