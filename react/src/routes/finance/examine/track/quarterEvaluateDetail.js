...
class QuarterEvaluatetDetail extends PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            modalVisible: false,
    ...
    confirmBtn = () => {
        ...
        const {quarter, flowId, flowLinkId, taskUUID, taskBatchid, tag} = this.props.location.query;
        const params = {
            quarter,
            type: 'quarter',
            opinion,
    ...
    render() {
        ...
        const {quarter} = location.query;
        const {unit, name, status} = indexMsg;
...
export default connect(mapStateToProps)(QuarterEvaluatetDetail);