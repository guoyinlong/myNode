...
export  default  class QueryUI extends React.Component{
  constructor(props){
    super(props);
    this.state={};
  }
    ...
    return(
      <Spin tip="加载中..." spinning={this.props.data.loading}>
        <div>
          ...
          <div style={{marginTop:'-23px'}}><TableSearch columns = {column} dataSource={list} needSearch={needSearch} scroll={{x:1420}}/></div>
        </div>
      </Spin>
    )
  }
