...
class branchFinanceSearch extends SearchUI{

  //需要搜索的字段
  needSearch=['payTime','deptName','teamName','applyUserName','claim_no'];
  //表格中的数据
  getHeader=()=>{
    return [
      {
...
export default connect(mapStateToProps)(branchFinanceSearch);
