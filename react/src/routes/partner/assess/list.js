...
class List extends React.Component {
    ...
    state={
        myData:this.props.assessListObj
    }
    componentWillReceiveProps(nextProps) {
        this.setState({myData: this.props.assessListObj});
    }
    ...
    clickItem = (record)=> {
        ...
        dispatch(routerRedux.push({
            pathname:'/projectApp/purchase/kpiAssessDetail',query
        }));
    }
...
function mapStateToProps (state) {
    const { assessListObj } = state.partnerAssessList;
    return {
        assessListObj,
        loading: state.loading.models.partnerAssessList
    };
}
