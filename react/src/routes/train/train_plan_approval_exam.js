...
class train_plan_approval_exam extends React.Component {
  constructor (props) {
    super(props);
...
//结束关闭
  ...
  render() {
    ...
    return (
      <div>
        <Row span={2} style={{textAlign: 'center'}}><h2>{new Date().getFullYear()}认证考试审批</h2></Row>
...
train_plan_approval_exam = Form.create()(train_plan_approval_exam);
export default connect(mapStateToProps)(train_plan_approval_exam);
