...
class Excel1 extends Component {
  onImportExcel = file => {
    ...
    fileReader.onload = event => {
      try {
        ...
        const {dispatch} = this.props;
        if(importType === 'general_compulsory_train_plan' ){
          dispatch({
        ...
        if(importType === 'general_elective_train_plan' ){
          dispatch({
        ...
        if(importType === 'branch_department_train' ){
          dispatch({
        ...
        if(importType === 'train_certification' ){
          dispatch({
