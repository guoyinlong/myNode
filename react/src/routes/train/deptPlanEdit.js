...
import {Button, Tabs, Modal, Spin, Radio, Form, Select, Input, Row, Col, message } from 'antd';
...
class deptPlanEdit extends Component {
    constructor(props) {
        super(props);
        this.state = {
          visible:false,
    ...
    handleOk = (e) => {
      ...
      this.setState({ isSubmitClickable: false });
        ...
        arg_train_group_update: this.props.form.getFieldValue("train_group_update"),
        arg_train_person_update :this.props.form.getFieldValue("train_person_update"),
        ...
        console.log("item=="+JSON.stringify(updateclassinfo));
    ...
    render() {
        ...
        const { item, permission } = this.props;
        let initperson = '';
        let nextdataList = '';
                                        ...
                                        <Row gutter={16}>
                                            <Col className="gutter-row" {...FormItemCol.preCol}>
                                                <FormItem label="培训对象" {...formItemLayout} >
                                                    {getFieldDecorator('train_group_update', {
                                                        rules: [{
                                                            required: true,
                                                            message: '培训对象是必填项'
                                                        }],
                                                        initialValue: 'train_group' in item ? item.train_group : ""
                                                    })
                                                    (
                                                        <TextArea
                                                            rows={1}
                                            ...
                                            <Col className="gutter-row" {...FormItemCol.preCol}>
                                                <FormItem label="培训人数" {...formItemLayout} >
                                                    {getFieldDecorator('train_person_update', {
                                                        rules: [{
                                                            required: true,
                                                            message: '培训人数是必填项，填写整数',
                                                            pattern:/^([1-9][0-9]*)?$/
                                                        }],
                                                        initialValue: 'train_person' in item ? item.train_person : ""
                                                    })
                                                    (
                                                        <TextArea
                                                            rows={1}
                                            ...
                                            <Col className="gutter-row" {...FormItemCol.preCol}>
                                                <FormItem label="责任部门" {...formItemLayout} >
                                                    {getFieldDecorator('dept_name_update', {
                                                        ...
                                                        initialValue: 'dept_name' in item ? item.dept_id : ""
                                                    })
                                                    (
                                                        <Select
                                                            placeholder='请选择部门'
                                        ...
                                        <Row gutter={16}>
                                          <Col className="gutter-row" {...FormItemCol.latCol}>
                                              <FormItem label="调整原因" {...textItemLayout} >
                                                  {getFieldDecorator('change_reason_update', {                                                        rules: [{
                                                            required: true,
                ...
                >
                    ...
                    <Form>
                        ...
                        {getFieldDecorator('nextstepPerson',{
                            ...
                            <Select initialValue={initperson} placeholder="请选择负责人">
                            {nextdataList}
                            </Select>)}
                        </FormItem>
                    </Form>
...
deptPlanEdit = Form.create()(deptPlanEdit);
export default connect(mapStateToProps)(deptPlanEdit);
