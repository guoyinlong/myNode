...
class CreateTrainApplye extends React.Component {
  constructor(props) {
    super(props);
        ...
        if (trainStartTime && trainEndTime) {
          ...
          if (this.diffDate(currentDate, trainStartTime)) {
            ...
            if (this.state.planValue === 1) {
              ...
              //培训申请类型
              basicOutPlanApplyData["arg_train_apply_type"] = '4';
            }
            else {
              //封装培训课程信息传给后台
              ...
              //培训申请类型
              basicApplyData["arg_train_apply_type"] = '4';
            }
            ...
            if (this.state.planValue === 1) {
              return new Promise((resolve) => {
                dispatch({
                  type: 'createApplyModel/trainClassOutPlanApplySubmit',
                ...
                if (resolve === 'success') {
                  ...
                  return new Promise((resolve) => {
                    dispatch({
                      type: 'createApplyModel/trainClassOutPlanPersonSubmit',
            ...
            //计划内
              ...
              return new Promise((resolve) => {
                dispatch({
                  type: 'createApplyModel/trainClassInPlanApplySubmit',
                  basicApplyData,
                  resolve
                });
              }).then((resolve) => {
          ...
          <Card title="申请信息" className={styles.r}>
            ...
            {/* 培训课程 */}
            {
              this.state.planValue === 0
                ...
                <Row style={{ textAlign: 'center' }}>
                  <Col >
                    <FormItem label="请选择计划外培训课程类型" hasFeedback {...formItemLayout}>
                      {getFieldDecorator('trainClassTypeOut', {
                        initialValue: 'compulsory',
                        rules: [
                          {
                            required: true,
                            message: '请选择计划外培训课程类型'
                          },
                        ],
                      })(
                        <Select placeholder="请选择计划外培训课程类型" initialValue={'compulsory'} disabled={false} onChange={this.applyClassType.bind(this)}>
                          <Option value="compulsory">全院级必修课程</Option>
                          <Option value="elective">全院级选修课程</Option>
                          <Option value="common1">全院级-其他培训计划</Option>
                          <Option value="common2">分院级培训计划</Option>
                    ...
                    <FormItem label="培训课程名称" {...formItemLayout} >
                      {getFieldDecorator('trainClassInput', {
                        ...
                        rules: [
                          {
                            required: true,
                            message: '请输入计划外培训课程名称'
                          },
                        ],
                      })(
                        <Input placeholder="请输入计划外培训课程名称" />
                      )}
                    </FormItem>
                    ...
                    <FormItem label="计划培训时长" {...formItemLayout} >
                        ...
                        rules: [
                          {
                            ...
                            message: '请输入计划外培训课程的计划培训时长(小时，6小时为1天，最多1位小数)'
                          },
                        ],
                      })(
                        <Input placeholder="请输入计划外培训课程的计划培训时长(小时，6小时为1天，最多1位小数)" />
                      )}
                    </FormItem>
...
CreateTrainApplye = Form.create()(CreateTrainApplye);
export default connect(mapStateToProps)(CreateTrainApplye)
