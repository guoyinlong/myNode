...
class CenterEleEdit extends Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
                        ...
                        <Col className="gutter-row" {...FormItemCol.preCol}>
                          <FormItem label="培训级别" {...formItemLayout} >
                            {getFieldDecorator('train_level_update', {
                              ...
                              initialValue: item.train_level ? item.train_level : ""
                            })
                              (
                                <Select
                                  disabled={false}
                                >
                                  <Option value="全院级选修课">全院级选修课</Option>
                                </Select>
                              )}
                          </FormItem>
                        </Col>
                        <Col className="gutter-row" {...FormItemCol.preCol}>
                          <FormItem label="培训计划类型" {...formItemLayout} >
                            {getFieldDecorator('class_type_update', {
                              ...
                              initialValue: item.class_type ? item.train_kind : ""
                            })
                              (
                                <Select
                                  disabled={false}
                                >
                                  ...
                                  <Option value={"外训-参加集团或者分子公司培训"}>外训-参加集团或者分子公司培训</Option>
                        ...
                        <Col className="gutter-row" {...FormItemCol.preCol}>
                          <FormItem label="赋分规则" {...formItemLayout} >
                            {getFieldDecorator('assign_score_update', {
                              ...
                              initialValue: item.assign_score ? item.assign_score : ""
                            })
                              (
                                <Select
                                  disabled={false}
                        ...
                        <Col className="gutter-row" {...FormItemCol.preCol}>
                          <FormItem label="培训时长" {...formItemLayout} >
                            {getFieldDecorator('train_hour_update', {
                              ...
                              initialValue: item.train_hour ? item.train_hour : "0"
                            })
                              (
                                <TextArea
                                  rows={1}
...
CenterEleEdit = Form.create()(CenterEleEdit);
export default connect(mapStateToProps)(CenterEleEdit)
