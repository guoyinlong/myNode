...
class train_in_planin_look extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
              ...
              {/*<Row style={{ textAlign: 'left' }}>
                <FormItem label="是否采购" hasFeedback {...formItemLayout}>
                  {getFieldDecorator('is_purchase', {
                    ...
                    <Select style={{color:'#000'}} onChange={this.isPurchase} placeholder = "" disabled={ approvalInfoRecord.step === "接口人提交执行培训" ? false  : true}>
                ...
                <FormItem label="请填写培训讲师（姓名）" hasFeedback {...formItemLayout}>
                  {getFieldDecorator('train_teacher', {
                    ...
                    <TextArea
                      ...
                      rows={4}
                      disabled={ approvalInfoRecord.step === "接口人提交执行培训" ? false  : true}
                    />
                  )}
                </FormItem>
              </Row>*/}
...
train_in_planin_look = Form.create()(train_in_planin_look);
export default connect(mapStateToProps)(train_in_planin_look)
