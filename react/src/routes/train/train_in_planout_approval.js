...
class train_in_planout_approval extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      visible: false,
  ...
  selectNext = () => {
    ...
    console.log("selectNext=="+JSON.stringify(approvalInfoRecord));
    if (approvalInfoRecord.step === '接口人提交执行培训' || approvalInfoRecord.step === "申请人组织培训") {
      ...
      if (trainUseFee === '' || trainUseFee === undefined || trainUseFee === null) {
        ...
        if (transferPersonClassGradeData.length > trainNumberPerson && approvalInfoRecord.train_apply_type === '2') {
          this.setState({
  ...
  handleOk = () => {
    ...
    if (approvalInfoRecord.step === '接口人提交执行培训' || approvalInfoRecord.step === "申请人组织培训") {
      ...
      if (transferPersonClassGradeData.length > 0) {
  ...
  render() {
    ...
    let showflag = "none";
    let showflag2 = "none";
    if (approvalInfoRecord.step === "接口人提交执行培训" || approvalInfoRecord.step === "申请人组织培训" || approvalInfoRecord.step === "部门负责人审核" || approvalInfoRecord.step === "部门负责人审核-执行完" || approvalInfoRecord.step === "人力接口人归档"|| approvalInfoRecord.step === "结束"|| approvalInfoRecord.step === "处理完毕"  ) {
      showflag = "";
    }
    if (approvalInfoRecord.step === "接口人提交执行培训" || approvalInfoRecord.step === "申请人组织培训") {
      showflag2 = "";
    ...
    console.log("nextPersonList==" + JSON.stringify(nextPersonList));
    let initperson = '';
    let nextdataList = '';
      ...
      <div>
        ...
        <Form>
          <Card title="申请信息" className={styles.r}>
            ...
            {/*培训课程级别*/}
            <Row style={{ textAlign: 'center' }}>
              <FormItem label="培训课程级别" hasFeedback {...formItemLayout}>
                {getFieldDecorator('train_class_level', {
                  initialValue: outClassInfo.train_class_level,
                })(
                  <TextArea
                    style={{ color: '#000', minHeight: 32 }}
                    placeholder="培训课程级别"
            ...
            {/*培训对象*/}
            <Row style={{ textAlign: 'center' }}>
              <FormItem label="培训对象" hasFeedback {...formItemLayout}>
                {getFieldDecorator('train_person', {
                  initialValue: outClassInfo.train_person,
                })(
                  <TextArea
                    style={{ color: '#000', minHeight: 32 }}
                    placeholder="培训对象"
            ...
            {/*计划培训人数*/}
            <Row style={{ textAlign: 'center' }}>
              <FormItem label="计划培训人数" hasFeedback {...formItemLayout}>
                {getFieldDecorator('train_class_person_num', {
                  initialValue: outClassInfo.train_class_person_num,
                })(
                  <TextArea
                    style={{ color: '#000', minHeight: 32 }}
                    placeholder="计划培训人数"
            ...
            {/*计划培训时长*/}
            <Row style={{ textAlign: 'center' }}>
              <FormItem label="计划培训时长" hasFeedback {...formItemLayout}>
                {getFieldDecorator('train_hour', {
                  initialValue: outClassInfo.train_hour,
                })(
                  <TextArea
                    style={{ color: '#000', minHeight: 32 }}
                    placeholder="计划培训时长"
            ...
            {/*培训师资*/}
            {/*<Row style={{ textAlign: 'center' }}>
              <FormItem label="培训师资" hasFeedback {...formItemLayout}>
                {getFieldDecorator('train_hour', {
                  initialValue:outClassInfo.train_hour,
                })(
                  <TextArea
            ...
            {/*学分值*/}
            <Row style={{ textAlign: 'center' }}>
              <FormItem label="学分值" hasFeedback {...formItemLayout}>
                {getFieldDecorator('class_grade', {
                  initialValue: outClassInfo.class_grade,
                })(
                  <TextArea
                    style={{ color: '#000', minHeight: 32 }}
                    placeholder="学分值"
            ...
            >
              ...
              <Row style={{ textAlign: 'center', display: showflag2 }}>
...
train_in_planout_approval = Form.create()(train_in_planout_approval);
export default connect(mapStateToProps)(train_in_planout_approval)
