...
class train_plan_look_com extends React.Component {
  constructor (props) {
    super(props);
...
//结束关闭
  ...
  render() {
    ...
    return (
    <div>
      <Row span={2} style={{textAlign: 'center'}}><h2>{new Date().getFullYear()}年总院必修培训计划查看</h2></Row>
...
train_plan_look_com = Form.create()(train_plan_look_com);
export default connect(mapStateToProps)(train_plan_look_com);
