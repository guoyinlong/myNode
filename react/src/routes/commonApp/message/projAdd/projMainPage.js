...
import ProjInfoModal from '../../../project/startup/projAdd/projInfoModal.js';
import MileStone from '../../../project/startup/projAdd/mileStone.js';
import ProjStartFullCost from '../../../project/startup/projAdd/projStartFullCost';
import Attachment from '../../../project/startup/projAdd/attachment';
...
import StartSubmitModal from '../../../project/startup/projAdd/startSubmitModal';
        ...
        return (
            <Spin tip={config.IS_LOADING} spinning={this.props.loading || this.props.fullCostLoading === true}>
                <div style={{background: 'white', padding: '10px 10px 10px 10px'}}>
                    ...
                    >
                        <TabPane tab="基本信息" key="t1" disabled={this.props.TMOchecked !== '-1'}>
                            <ProjInfoModal
                                ref="projInfoModal"
                                dispatch={dispatch}
                        ...
                        <TabPane tab="里程碑" key="t2" disabled={this.props.TMOchecked !== '-1'}>
                            <MileStone
                                dispatch={dispatch}
                                ref="mileStone"
                        ...
                        <TabPane tab="附件" key="t4" disabled={this.props.TMOchecked !== '-1'}>
                            <Attachment
                                dispatch={dispatch}
                                ref="attachment"
