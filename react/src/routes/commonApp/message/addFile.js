...
import { Tabs, Button, Table,Radio,Popconfirm, Input} from 'antd';
import styles from '../../meetingManagement/meetingTable.less';
import FileUpload from './addFileUpload.js';
import {routerRedux} from "dva/router"; //上传功能组件
            ...
            <TabPane tab="议题详情" key="1">
              <div style={{margin:'0 auto',width:'800px'}}>
                ...
                <div style={{marginTop:'15px'}}>
                  ...
                  <span style={{display:'inline-block', width:'10px',textAlign: 'left'}}>:</span>
                  <RadioGroup onChange={this.isSecret} value={this.props.meetingRadioValue}>
                ...
                <div style={{marginTop:'15px',display: this.props.materialDetailDisplay }} >
                 <span style={{display:'inline-block', width:'160px',textAlign: 'right'}}>
                  ...
                  <span style={{display:'inline-block', width:'10px',textAlign: 'left'}}>:</span>
                  <Input style={{width:'500px'}} value={this.props.secretReason} onChange={this.handleMeetingChange}/>
                </div>
