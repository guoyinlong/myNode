...
//选择部门组合
class RelativeDeptRadioGroup extends React.Component {
  state={
    ouDeptList:[],
  ...
  onChange = (e,cItem) => {
    ...
    /*console.log(cItem);*/
    this.props.dispatch({
      type:'sealComReset/onRelativeDeptChecked',
      value:e
    })
  };

  //取消选中时
  cancelChange = (e,cItem) => {
    this.props.dispatch({
      type:'sealComReset/cancelDeptChecked',
      value:e
    })
  };
              ...
              <Col xs={4} sm={4} md={4} lg={4} xl={4} offset={cIndex === 1 || cIndex === 2?2:0} key={cItem.dept_id}>
                ...
                {cItem.child.map((CCItem,CCIndex)=>
                  <Checkbox
                    ...
                    defaultChecked={this.props.relativeDeptID.some(i=>i ===CCItem.dept_id)}
...
export default connect(mapStateToProps)(RelativeDeptRadioGroup);
