...
class LeaderIDReset extends React.Component {
  state = {
  ...
  deleteUpload= (e,record)=>{
    /*console.log(record);*/
      this.props.dispatch({
        type:'leaderIDReset/localDeleteUpload',
        record:record
      })
  };
  ...
  getSealTypeId = (value)=>{
    //console.log(value);
    this.props.dispatch({
      type:'leaderIDReset/getSealTypeId',
      record : value,
    })
  };
  render(){
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.leaderIDReset,
    ...state.leaderIDReset
  };
}
export default connect(mapStateToProps)(LeaderIDReset);
