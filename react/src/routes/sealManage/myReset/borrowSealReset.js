...
class BorrowSealReset extends React.Component {
  state = {
  ...
  getStartTime=(value, dateString)=>{
    ...
    this.props.dispatch({
      type:'borrowSealReset/getStartTime',
      record : dateString,
    })
  };
//获取所选归还时间
  getEndTime=(value, dateString)=>{
    /* console.log(value, dateString);*/
    this.props.dispatch({
      type:'borrowSealReset/getEndTime',
      record : dateString,
    })
  };
  ...
  getSealTypeId = (value)=>{
    this.props.dispatch({
      type:'borrowSealReset/getSealTypeId',
      record : value,
    })
  };
//不可选当前时间之前的时间
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.borrowSealReset,
    ...state.borrowSealReset
  };
}
export default connect(mapStateToProps)(BorrowSealReset);
