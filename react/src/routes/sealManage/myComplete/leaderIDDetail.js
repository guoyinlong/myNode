...
class LeaderIDDetail extends React.Component {
  state = {
...
function mapStateToProps (state) {
  return {
    loading: state.loading.models.leaderIDDetail,
    ...state.leaderIDDetail
  };
}
export default connect(mapStateToProps)(LeaderIDDetail);
