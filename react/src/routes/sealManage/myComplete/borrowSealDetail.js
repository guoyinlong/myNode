...
class BorrowSealDetail extends React.Component {
  state = {
                  ...
                  <div className={styles.lineOut}>
                    ...
                    <aside style={{width:'76%',float:'right'}}>
                      <p style={{lineHeight:'25px'}}>
                        ...
                        工作需要，需申请借用 &nbsp;{this.props.dataInfo.seal_details_name} 。
                      </p>
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.borrowSealDetail,
    ...state.borrowSealDetail
  };
}
export default connect(mapStateToProps)(BorrowSealDetail);
