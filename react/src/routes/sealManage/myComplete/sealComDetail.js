...
import { Input, Modal, Button,Table, Tabs, } from "antd";
...
class SealComDetail extends React.Component {
  state = {
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.sealComDetail,
    ...state.sealComDetail
  };
}
export default connect(mapStateToProps)(SealComDetail);
