...
class BusinessLicenseJudge extends React.Component {
  state = {
  ...
  returnModel =(value,value2)=>{
    ...
    if(value2!==undefined){
      this.props.dispatch({
        type:'businessLicenseJudge/'+value,
        record : value2,
      })
    }else{
      /* console.log('aaa');*/
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.businessLicenseJudge,
    ...state.businessLicenseJudge
  };
}
export default connect(mapStateToProps)(BusinessLicenseJudge);
