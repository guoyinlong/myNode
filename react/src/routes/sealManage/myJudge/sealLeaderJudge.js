...
class SealLeaderJudge extends React.Component {
  state = {
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.sealLeaderJudge,
    ...state.sealLeaderJudge
  };
}
export default connect(mapStateToProps)(SealLeaderJudge);
