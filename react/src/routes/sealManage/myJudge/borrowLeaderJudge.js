...
class BorrowLeaderJudge extends React.Component {
  state = {
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.borrowLeaderJudge,
    ...state.borrowLeaderJudge
  };
}
export default connect(mapStateToProps)(BorrowLeaderJudge);
