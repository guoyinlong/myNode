...
class BorrowSealJudge extends React.Component {
  state = {
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.borrowSealJudge,
    ...state.borrowSealJudge
  };
}
export default connect(mapStateToProps)(BorrowSealJudge);
