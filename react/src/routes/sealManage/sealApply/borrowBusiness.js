...
class BorrowBusiness extends React.Component {
  state = {
  ...
  getSealTypeId = (value)=>{
    console.log(value);
    this.props.dispatch({
      type:'borrowBusiness/getSealTypeId',
      record : value,
    })
  };
  ...
  getStartTime=(value, dateString)=>{
   /* console.log(value, dateString);*/
    this.props.dispatch({
      type:'borrowBusiness/getStartTime',
      record : dateString,
    })
  };
//获取所选归还时间
  getEndTime=(value, dateString)=>{
    /* console.log(value, dateString);*/
    this.props.dispatch({
      type:'borrowBusiness/getEndTime',
      record : dateString,
    })
  };
        ...
        <div className={styles.out}>
          ...
          <div className={styles.lineOut}>
            ...
            <Select  className={styles.lineSelect} onChange={this.getSealTypeId}>
               {this.props.sealList.map((i)=><Option key={i.seal_details_name} value={JSON.stringify(i)}>{i.seal_details_name}</Option>)}
            </Select>
          </div>
          ...
          <div className={styles.lineOut}>
            ...
            <aside style={{width:'76%',float:'right'}}>
              <p style={{lineHeight:'25px'}}>
                ...
                工作需要，需申请借用{this.props.sealName}。
              </p>
              <p className={styles.lineP}>
                ...
                <DatePicker
                  ...
                  showTime={{ defaultValue: moment('00:00:00', 'HH:mm:ss') }}                /*onOk={this.sureStartTime}*/
                />
                &nbsp;&nbsp;&nbsp;
                预计归还时间为
                <DatePicker
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.borrowBusiness,
    ...state.borrowBusiness
  };
}
export default connect(mapStateToProps)(BorrowBusiness);
