...
class BorrowLeader extends React.Component {
  state = {
  ...
  getStartTime=(value, dateString)=>{
    ...
    this.props.dispatch({
      type:'borrowLeader/getStartTime',
      record : dateString,
    })
  };
//获取所选归还时间
  ...
  getSealTypeId = (value)=>{
    this.props.dispatch({
      type:'borrowLeader/getSealTypeId',
      record : value,
    })
  };
//不可选当前时间之前的时间
          ...
          <div className={styles.lineOut}>
            ...
            <aside style={{width:'76%',float:'right'}}>
              <p style={{lineHeight:'25px'}}>
                ...
                工作需要，需申请借用 {this.props.sealName}  领导的章。
              </p>
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.borrowLeader,
    ...state.borrowLeader
  };
}
export default connect(mapStateToProps)(BorrowLeader);
