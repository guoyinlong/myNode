...
class BusinessLicenseApply extends React.Component {
  state = {
  ...
  returnModel =(value,value2)=>{
    ...
    if(value2!==undefined){
      this.props.dispatch({
        type:'businessLicenseApply/'+value,
        record : value2,
      })
    }else{
      console.log('aaa');
  ...
  getSealTypeId = (value)=>{
    //console.log(value);
    this.props.dispatch({
      type:'businessLicenseApply/getSealTypeId',
      record : value,
    })
  };
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.businessLicenseApply,
    ...state.businessLicenseApply
  };
}
export default connect(mapStateToProps)(BusinessLicenseApply);
