...
class setNewTask extends React.PureComponent {
  ...
  saveData = (values) => {
	...
	//----------------------页面渲染----------------------//
	render() {
		const {taskTypes, checkObjectAndContentList, checkContentList, roleType, roleList, flag, examineImgId} = this.props;
		...
		return(
			<Spin tip="加载中..." spinning={this.props.loading}>
					<div className={styles.pageContainer}>
						<h2 style = {{textAlign:'center',marginBottom:30}}>修改任务</h2>
            ...
            <span className={styles.lineColon}>：</span>
						...
						<div className={styles.lineOut}>
							...
							<div style = {{width: 570,marginLeft: 190, marginTop: -18}}>
								<FileUpload dispatch={this.props.dispatch} loading = {this.props.loading} pageName='setNewTask' fileList ={examineImgId}
