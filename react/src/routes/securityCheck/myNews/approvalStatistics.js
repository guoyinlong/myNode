...
class tongjishenpibaogao extends React.Component {
  state =  {
    value:1,
    inforid:"",
    Eurl:"",
...
submit =()=>{
  ...
  dispatch({
    type:"tongjishenpibaogao/tbSubmit",
    // payload:{
      argOpinion:value,
      argInfoId:inforid
    // }
...
const{examineImgId,taskList}=this.props
...
{taskList.length>0?
        ...
        <div className={styles.out}>
          ...
          <div className={styles.lineOut3}>
                ...
                <span className={styles.lineColon}>:</span>
                <div className={styles.jieguo}>{taskList[0].result}</div>
            </div>
...
const form1 = Form.create()(tongjishenpibaogao);
function mapStateToProps (state) {

  return {
    loading: state.loading.models.tongjishenpibaogao,
    ...state.tongjishenpibaogao
  };
}
