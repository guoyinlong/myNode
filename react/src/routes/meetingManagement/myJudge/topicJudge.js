...
class TopicJudge extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleModalCancel = () => {
    this.props.dispatch({
      type: 'topicJudge/handleModalCancel'
    })
  };
  ...
  render() {
    ...
    /* console.log(this.props.topicJudge)*/
    return (
...
function mapStateToProps(state) {
  ...
  return {
    loading: state.loading.models.topicJudge,
    ...state.topicJudge
  };
}
export default connect(mapStateToProps)(TopicJudge);