...
//选择部门组合
class ResetDept extends React.Component {
  state={
    ouDeptList:[],
  ...
  cancelChange = (e,cItem) => {
    this.props.dispatch({
      type:'topicReset/cancelDeptChecked',
      value:e
    })
  };
              ...
              <Col xs={4} sm={4} md={4} lg={4} xl={4} offset={cIndex === 1 || cIndex === 2?2:0} key={cItem.dept_id}>
                ...
                {cItem.child.map((CCItem,CCIndex)=>
                  <Checkbox
                    ...
                    defaultChecked={this.props.deptId.some(i=>i ===CCItem.dept_id)}
                  >
...
export default connect(mapStateToProps)(ResetDept);
