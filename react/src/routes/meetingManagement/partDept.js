...
//选择部门组合
class PartDept extends React.Component {
  state={
    ouDeptList:[],
  ...
  onChange = (e,cItem) => {
    ...
    this.props.dispatch({
      type:'topicWrite/outPartDeptChecked',
      value:e
    });
  };
              ...
              <Col xs={4} sm={4} md={4} lg={4} xl={4} offset={cIndex === 1 || cIndex === 2?2:0} key={cItem.dept_id}>
                ...
                {cItem.child.map((CCItem,CCIndex)=>
                  <Checkbox
                    ...
                    disabled={this.props.deptId.some(i=>i ===CCItem.dept_id)}
                  >
...
export default connect(mapStateToProps)(PartDept);
