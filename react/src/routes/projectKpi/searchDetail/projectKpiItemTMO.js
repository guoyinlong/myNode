    ...
    render() {
        return (
            <div className={Style.kpiBox}>
                ...
                {/* {
                    this.props.kpi.kpi_assessment === "0"  && this.props.kpi.kpi_flag === "0"
                    // this.props.kpi.kpi_flag === "0"
                    ?
                    <div>
                        <span>考核豁免：</span>
                        <span>{this.props.kpi.reason}</span>
                    </div>
                    :
                    ""
                } */}
                ...
                {
                    this.props.kpi.kpi_assessment && this.props.kpi.kpi_flag === "0"
                    ?
                    <div style = {{display:"flex",alignItems:'center'}}>
                        <span style = {{ width:'auto',whiteSpace:'nowrap'}}>考核方式变更：</span>
                ...
                }
                {
                    ...
                    ?
                    <div style = {{display:"flex",alignItems:'center'}}>
                        <span style = {{ width:'auto',whiteSpace:'nowrap'}}>申请变更理由：</span>
                        <span>{this.props.kpi.reason}</span>
                    </div>
                    :
                    ""
