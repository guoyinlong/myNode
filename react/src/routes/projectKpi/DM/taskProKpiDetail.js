    ...
    handleModalOkClick = (value) => {
        ...
        dispatch({
            ...
            params:{
              ...
              arg_dept: this.props.managerTitleObj[0].proj_dept_name,
            }
        });
        ...
        return (
            <div className={styles['pageContainer']}>
                ...
                <Spin tip="处理中..." spinning={this.props.loading}>
                        ...
                        <Col span={24} className={styles['middle-box']}>
                            <div className={styles['middle-inner']}>
                                ...
                                <ul style={{textAlign: 'center'}}>
                                  ...
                                  {this.props.isDM?<li><b>当前环节</b>: 归口部门经理&lt;审批+评价&gt;</li>:<li><b>当前环节:</b>: 归口部门接口人&lt;审批+评价&gt;</li>}
                                    {
                    ...
                    {   titleObj.next_link_name == "部门经理<审批+评价>"
                        ?
                        <Row style = {{textAlign:"center"}}>
                            <span style = {{fontSize:"13"}}>该项目已审请【自主研发（运维）占比】指标由事业部经理全权打分，不受平台考核结果影响，特此提醒。</span>
                        </Row>
                        :
                        null
                    }
...
function mapStateToProps (state) {
    const {loading,historys,modalVisible,taskObj,managerDetailObj,managerTitleObj, showBack, isDM} = state.taskDeatilTMO;
    return {
        loading,
        historys,
        modalVisible,
