    ...
    getFields() {
        ...
        return (
            <div >起始时间：
                            ...
                            <Select style={{width:"70px"}} value={year} onChange={(value)=>handleChange({'startYear':value,'startSeason':season})} >
                                {yearOption}
                            </Select>
                            &nbsp;&nbsp;
                            <Select style={{width:"80px"}} value={season} onChange={(value)=>handleChange({'startYear':year,'startSeason':value})} >
