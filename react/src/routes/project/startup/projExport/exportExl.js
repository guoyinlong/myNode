...
let exportExl = function () {
  ...
  function method1(tableid, tabName) {//整个表格拷贝到EXCEL中
    if (getExplorer() === 'ie') {
      ...
      let fname;
      try {
        fname = oXL.Application.GetSaveAsFilename(tabName + ".xls", "Excel Spreadsheets (*.xls), *.xls");
      } catch (e) {
  ...
  let tableToExcel = (function () {
    ...
    return function (table, name) {
      ...
      let ctx = {worksheet: name || 'Worksheet', table: table1.innerHTML};
