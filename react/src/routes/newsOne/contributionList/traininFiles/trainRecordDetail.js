...
class trainRecordDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  callback=(e)=> {
    if(e==1){
        this.props. dispatch({
            type:"trainRecordDetail/queryTrainDetail",
          })
    }else if(e==2){
        this.props. dispatch({
            type:"trainRecordDetail/queryTrainExamineItem",
            })
    }
}
  //审批环节
          ...
          <Tabs defaultActiveKey="1" onChange={(e)=>this.callback(e)}>
            <TabPane tab="申请详情" key="1">
              <div className={styles.out}>
                ...
                {/* <div className={styles.lineOut}>
                  <span className={styles.lineKey}>人员名字</span>
                  <span style={{display:'inline-block', width:'10px',textAlign: 'left',marginLeft:'5px'}}>:</span>
                ...
                </div>
                {
                  this.props.trainType == '线上'?
                    <div className={styles.lineOut}>
                      <span className={styles.lineKey}>考试题目回答情况</span>
                      <span style={{display:'inline-block', width:'10px',textAlign: 'left',marginLeft:'5px'}}>:</span>
                      <Table
...
function mapStateToProps (state) {
  return {
    loading: state.loading.models.trainRecordDetail,
    ...state.trainRecordDetail
  };
}

export default connect(mapStateToProps)(trainRecordDetail);