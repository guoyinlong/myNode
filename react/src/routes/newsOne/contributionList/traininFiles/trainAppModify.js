...
class trainAppModify extends Component {
  constructor(props){
    super(props);
    this.state= {
      uploadFile:{
  ...
  changeDate = (date,dateString) => {
    this.props.dispatch({
      type: 'trainAppModify/changeDate',
    ...
    return(
      <div  className={styles.outerField}>
        <div className={styles.out}>
          <h2 style={{margin:'0 auto',width:'800px',textAlign:'center',fontSize:'20px'}}>培训修改</h2>
          ...
          <div style={{marginTop:'20px'}}>
            {
              this.props.typeValue == "0" ?
                <div>
                  ...
                  <span style={{display:'inline-block', width:'10px',textAlign: 'left',marginLeft:'5px',marginRight:'10px'}}>:</span>
                  <Upload  {...this.state.uploadFile} onChange = {(e)=>this.handleMole("trainingMaterialChange",'培训证明材料',e)}>
...
function mapStateToProps (state) {
  return {
    loading: state.loading.models.trainAppModify,
    ...state.trainAppModify
  };
}

export default connect(mapStateToProps)(trainAppModify);