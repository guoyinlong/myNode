...
class newManuscriptReview extends React.PureComponent {
  returnModel =(value,value2,value3)=>{
    if(value2!==undefined){
        this.props.dispatch({
            type:'newManuscriptReview/'+value,
            record : value2,
            name : value3,
        })
    }else{
      ...
      changeDate = (date,dateString) => {
        this.props.dispatch({
          type:"newManuscriptReview/changeDate",
          dateString
        });
            };
	...
	return(
            <div className={styles.pageContainer}>
						<h2 style = {{textAlign:'center',marginBottom:30}}>稿件复核填报</h2>
...
function mapStateToProps (state) {
  return {
    loading: state.loading.models.newManuscriptReview, 
    ...state.newManuscriptReview
  };
}
export default connect(mapStateToProps)(newManuscriptReview);
