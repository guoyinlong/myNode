...
class newBonus extends React.PureComponent {
  state={ }
	...
	return(
            <div className={styles.pageContainer}>
						<h2 style = {{textAlign:'center',marginBottom:30}}>加分项填报</h2>
                        ...
                        <div className={styles.lineOut}>
                          ...
                          <span className={styles.lineColon}>：</span>
                            ...
                            <div className={styles.lineOut}>
                                            ...
                                            <span className={styles.lineColon}>：</span>
                                            <FileUpload dispatch={this.props.dispatch} passFuc = {this.saveData} pageName='newBonus'/>
                                            <Table
                                            columns={ columns1 }
...
function mapStateToProps (state) {
  return {
    loading: state.loading.models.newBonus, 
    ...state.newBonus
  };
}
export default connect(mapStateToProps)(newBonus);
