...
class ExperienceSharingWrite extends React.Component{
    state = {
      ...
      updateFilePath=(value)=>{
        this.props.dispatch({
          type:'experienceSharingWrite/saveUploadFile',
          value:value
        })
      };
      ...
      returnModel =(value,value2)=>{
        if(value2!==undefined){
          this.props.dispatch({
            type:'experienceSharingWrite/'+value,
            record : value2,
          })
        }else{
          this.props.dispatch({
  ...
  downloadUpload = (e,record) =>{
    ...
    deleteUpload = (e,value)=>{
          this.props.dispatch({
            type:'experienceSharingWrite/deleteUpload',
            record:value
          })
        };
      ...
      <div className={styles.out}>
          ...
          <div style={{width:'250px',margin:'20px auto'}}>
            <div style={{margin:'0 auto'}}>
              <Button type="primary" style={{float:'left'}} onClick={()=>this.returnModel('saveCase')}>保存</Button>
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.experienceSharingWrite,
    ...state.experienceSharingWrite
  };
}
export default connect(mapStateToProps)(ExperienceSharingWrite);
