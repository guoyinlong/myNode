...
class PublicityChannelsReset extends React.Component{
    state = {
      ...
      returnModel =(value,value2)=>{
        if(value2!==undefined){
          this.props.dispatch({
            type:'publicityChannelsReset/'+value,
            record : value2,
          })
        }else{
          this.props.dispatch({
      ...
      handleChannelTypeChange=(value)=>{
        this.props.dispatch({
          type:'publicityChannelsReset/saveType',
          record: value,
        })
      };
      ...
      handleProvinceChange = value => {
        ...
        this.props.dispatch({
          type:'publicityChannelsReset/saveProvinceChange',
          record: value,
        })
      };
      ...
      onSecondCityChange = value => {
        ...
        this.props.dispatch({
          type:'publicityChannelsReset/onSecondCityChange',
          record: value,
        })
      };
    ...
    return (
      ...
      <div className={styles.out}>
          ...
          <div className={styles.lineOut}>
            ...
            <span>{this.props.dataInfo.createTime}</span>
          </div>
          <div className={styles.lineOut}>
            <span className={styles.lineKey}>
               <b className={styles.lineStar}>*</b>
            ...
            <span className={styles.lineColon}>:</span>
            <Select  className={styles.lineSelect} onChange={this.handleChannelTypeChange} value={this.props.channelTypeSeleted}>
          ...
          <div className={styles.lineOut}>
            ...
            <Input value={ this.props.channelName } style={{width:'500px'}} onChange={(e)=>this.returnModel('handleChannelNameChange',e)}/>
          </div>
...
function mapStateToProps (state) {
  ...
  return {
    loading: state.loading.models.publicityChannelsReset,
    ...state.publicityChannelsReset
  };
}
export default connect(mapStateToProps)(PublicityChannelsReset);
